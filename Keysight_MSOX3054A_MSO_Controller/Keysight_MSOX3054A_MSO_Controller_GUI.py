...
class frame_Main ( wx.Frame ):
	...
	def __init__( self, parent ):
		wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Keysight_MSOX3054A_MSO_Controller", pos = wx.DefaultPosition, size = wx.Size( 950,500 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
		...
		self.m_staticText4 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Counts", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText4.Wrap( -1 )

		self.m_staticText4.SetFont( wx.Font( 14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Sans" ) )

		fgSizer1.Add( self.m_staticText4, 2, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )

		self.panel_counts = wx.Panel( self.m_panel6, wx.ID_ANY, wx.DefaultPosition, wx.Size( -1,-1 ), wx.BORDER_SIMPLE )
		self.panel_counts.SetMinSize( wx.Size( 200,-1 ) )

		fgSizer1.Add( self.panel_counts, 2, wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer1.Add( self.m_staticText71, 5, wx.ALL|wx.EXPAND, 5 )

		self.m_staticText5 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"AC RMS Voltage", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText5.Wrap( -1 )

		self.m_staticText5.SetFont( wx.Font( 14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Sans" ) )

		fgSizer1.Add( self.m_staticText5, 2, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )
		...
		self.m_staticText6 = wx.StaticText( self.m_panel6, wx.ID_ANY, u"Line to Neutral Voltage", wx.DefaultPosition, wx.DefaultSize, wx.ALIGN_RIGHT )
		self.m_staticText6.Wrap( -1 )

		self.m_staticText6.SetFont( wx.Font( 14, wx.FONTFAMILY_SWISS, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "Sans" ) )

		fgSizer1.Add( self.m_staticText6, 2, wx.ALL|wx.ALIGN_CENTER_HORIZONTAL|wx.ALIGN_CENTER_VERTICAL|wx.EXPAND, 5 )

		self.panel_LtoN = wx.Panel( self.m_panel6, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, wx.BORDER_SIMPLE )
		self.panel_LtoN.SetMinSize( wx.Size( 20,-1 ) )

		fgSizer1.Add( self.panel_LtoN, 2, wx.EXPAND |wx.ALL, 5 )
		...
		# Grid
		self.grid_Data.CreateGrid( 15, 3 )
		...
		self.grid_Data.SetColLabelValue( 2, u"L-N" )
